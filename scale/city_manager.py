...
NIGERIAN_CITIES = {
    ...
    "Abuja": {
        ...
        "population": "3.6M", "tier": 1,
        "economic_profile": "Government, diplomacy, corporate HQs, high-income residents",
        "best_niches": ["restaurants", "clinics", "schools", "hotels", "law_firms", "real_estate"],
    ...
    "Lagos": {
        ...
        "population": "15M+", "tier": 1,
        "economic_profile": "Finance, trade, entertainment, tech, fashion",
        "best_niches": ["restaurants", "salons", "gyms", "hotels", "real_estate", "contractors"],
    ...
    "Ikeja": {
        "state": "Lagos", "region": "South West", "tier": 1,
    ...
    "Kano": {
        ...
        "population": "4.1M", "tier": 1,
        "economic_profile": "Trade, textile, agriculture, leather",
        "best_niches": ["pharmacies", "schools", "hotels", "supermarkets", "contractors"],
    ...
    "Onitsha": {
        ...
        "population": "1M", "tier": 2,
        "economic_profile": "Major trade hub, textiles, electronics",
        "best_niches": ["supermarkets", "contractors", "pharmacies", "schools", "restaurants"],
    ...
    "Warri": {
        ...
        "population": "700K", "tier": 2,
        "economic_profile": "Oil & gas services, trade, fishing",
        "best_niches": ["restaurants", "hotels", "contractors", "pharmacies", "clinics"],
        "avg_spending_power": "medium_high",
        "digital_adoption": "medium",
        "competition": "low",
    ...
    "Ilorin": {
        ...
        "best_niches": ["restaurants", "schools", "salons", "pharmacies", "supermarkets"],
        "avg_spending_power": "medium",
        "digital_adoption": "medium",
        "competition": "low",
    ...
    "Ekpoma": {
        "state": "Edo", "region": "South South",
        "population": "200K", "tier": 3,
        "economic_profile": "Major educational hub, university town, agriculture, retail and local trade",
        "best_niches": ["restaurants", "salons", "pharmacies", "schools", "hotels", "boutiques", "laundry"],
        "avg_spending_power": "medium",
        "digital_adoption": "medium",
        "competition": "very_low",
    ...
    "Auchi": {
        "state": "Edo", "region": "South South",
        "population": "150K", "tier": 3,
        "economic_profile": "Educational hub, polytechnic town, limestone and mining, local trade",
        "best_niches": ["restaurants", "salons", "pharmacies", "schools", "churches", "bakeries", "laundry"],
        "avg_spending_power": "low_medium",
    ...
    "Agbor": {
        ...
        "best_niches": ["supermarkets", "pharmacies", "schools", "churches", "restaurants", "contractors", "bakeries"],
        "avg_spending_power": "medium",
        "digital_adoption": "low_medium",
        "competition": "very_low",
    ...
    "Sapele": {
        ...
        "best_niches": ["restaurants", "hotels", "salons", "pharmacies", "contractors", "boutiques", "printing_press"],
        "avg_spending_power": "medium",
        "digital_adoption": "medium",
        "competition": "low",
    ...
    "Nsukka": {
        "state": "Enugu", "region": "South East",
        "population": "300K", "tier": 3,
        "economic_profile": "Academic hub, major university town, agricultural trade",
        "best_niches": ["restaurants", "salons", "schools", "hotels", "pharmacies", "churches", "boutiques"],
        "avg_spending_power": "medium",
        "digital_adoption": "medium",
        "competition": "very_low",
        "language_notes": "Igbo, English"
    ...
    "Ogbomoso": {
        "state": "Oyo", "region": "South West",
        "population": "350K", "tier": 3,
        "economic_profile": "Agricultural hub, education center, university town, local commerce",
        "best_niches": ["restaurants", "schools", "pharmacies", "clinics", "salons", "bakeries", "event_centers"],
        "avg_spending_power": "low_medium",
        "digital_adoption": "low_medium",
        "competition": "very_low",
        "language_notes": "Yoruba, English"
...
def get_city_strategy(city_name: str) -> dict:
    ...
    price_multiplier = {
        "very_high": 1.5, "high": 1.2, "medium_high": 1.1,
        "medium": 1.0, "low_medium": 0.85, "low": 0.7
    }.get(spending, 1.0)

    # Adjust daily limits based on competition
    volume_multiplier = {
        "very_high": 0.6, "high": 0.8, "medium": 1.0,
        "low": 1.2, "very_low": 1.5
    }.get(competition, 1.0)
    ...
    for niche in best_niches:
        ...
        niche_revenue.append({
            ...
            "avg_deal_ngn": int(niche_cfg.get("avg_deal_ngn", 200000) * price_multiplier),
            "retainer_ngn": int(niche_cfg.get("monthly_retainer_ngn", 60000) * price_multiplier)
        })
...
def list_cities_by_tier() -> str:
    ...
    for tier in [1, 2, 3]:
        tier_cities = {
            k: v for k, v in NIGERIAN_CITIES.items()
            if v.get("tier") == tier
        }
        tier_labels = {1: "Tier 1 — Major Cities", 2: "Tier 2 — State Capitals", 3: "Tier 3 — Growing Towns"}
...
if __name__ == "__main__":
    ...
    if "--list" in sys.argv:
        ...
        for i, city_data in enumerate(roadmap, 1):
            print(f"  {i}. {city_data['city']} ({city_data['state']}) — {city_data['why']}")
    else:
        print(list_cities_by_tier())