...
NICHES = {
    ...
    "salons": {
        ...
        "lead_score_weight": {"no_website": 3, "no_booking": 3, "no_instagram": 2},
    },
    "clinics": {
    ...
    "hotels": {
        ...
        "lead_score_weight": {"no_website": 4, "no_booking": 4, "no_photos": 2},
    },
    "pharmacies": {
        ...
        "audit_criteria": [
            "has_catalog",
            "has_whatsapp_ordering",
            "has_delivery",
            "google_profile_complete",
        ],
        "lead_score_weight": {"no_website": 3, "no_whatsapp": 3, "no_delivery": 2},
    },
    "churches": {
        ...
        "lead_score_weight": {"no_website": 3, "no_giving": 4, "no_streaming": 2},
    },
    "real_estate": {
        "label": "Real Estate",
        "icon": "🏠",
        ...
        "lead_score_weight": {"no_website": 5, "no_listings": 4, "no_virtual_tour": 2},
    },
    "contractors": {
    ...
    "supermarkets": {
        ...
        "lead_score_weight": {"no_website": 3, "no_ordering": 4, "no_delivery": 3},
    },
    "gyms": {
        "label": "Gyms & Fitness",
        "icon": "💪",
        ...
        "audit_criteria": [
            "has_booking",
            "has_membership_system",
            "has_instagram",
            "has_transformation_gallery",
        ],
        "lead_score_weight": {"no_website": 3, "no_booking": 3, "no_instagram": 3},
    },
    "law_firms": {
        ...
        "audit_criteria": [
            "has_professional_site",
            "has_attorney_profiles",
            "has_consultation_booking",
            "has_legal_blog",
        ],
        "lead_score_weight": {"no_website": 5, "no_profiles": 3, "no_booking": 2},
    },
    "bakeries": {
    ...
    "boutiques": {
        ...
        "audit_criteria": [
            "has_ecom_site",
            "has_instagram_shop",
            "has_delivery_integration",
            "has_automated_checkout",
            "has_whatsapp_bot",
        ],
        "lead_score_weight": {
            "no_website": 4,
    ...
    "car_dealers": {
        ...
        "audit_criteria": [
            "has_inventory_site",
            "has_virtual_walkaround",
            "has_testdrive_booking",
            "has_whatsapp_bot",
            "google_profile_complete",
        ],
        "lead_score_weight": {
...
"""
    ...
    try:
        ...
        return (
            hooks[0].format(name, city)
            if hooks
            else f"We noticed some exciting opportunities for {name}."
        )
...
def get_niche_revenue_estimate(niche_key: str, lead_count: int) -> dict:
    ...
    return {
        ...
        "annual_revenue_ngn": (expected_clients * avg_deal)
        + (expected_clients * retainer * 12),
